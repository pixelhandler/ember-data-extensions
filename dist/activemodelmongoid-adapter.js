...
/**
  The EmbeddedRecordsMongoidMixin allows you to add embedded record support to your
  serializers.
  To set up embedded records, you include the mixin into the serializer and then
  define your embedded relations.

  ```js
  App.PostSerializer = DS.ActiveModelSerializer.extend(DS.EmbeddedRecordsMongoidMixin, {
    attrs: {
  ...
  @class EmbeddedRecordsMongoidMixin
  @namespace DS
*/
DS.EmbeddedRecordsMongoidMixin = Ember.Mixin.create({
...
/**
  The ActiveModelMongoidSerializer is a subclass of the RESTSerializer designed to integrate
  with a JSON API that uses an underscored naming convention instead of camelcasing.
  It has been designed to work out of the box with the
  [active_model_serializers](http://github.com/rails-api/active_model_serializers)
  Ruby gem.

  @class ActiveModelMongoidSerializer
  @constructor
  @namespace DS
  @extends DS.RESTSerializer
**/
DS.ActiveModelMongoidSerializer = DS.RESTSerializer.extend(DS.EmbeddedRecordsMongoidMixin, {
  // SERIALIZE
