...
module("mixins - HasManyEmbeddedRecordsMixin", {
  setup: function() {
    ...
    env.container.register('serializer:application', DS.ActiveModelSerializer.extend(DS.HasManyEmbeddedRecordsMixin));
    env.container.register('serializer:ams',         DS.ActiveModelSerializer.extend(DS.HasManyEmbeddedRecordsMixin));
...
test("extractSingle with embedded objects (hasMany relationship)", function() {
  ...
  env.container.register('serializer:homePlanet', DS.ActiveModelSerializer.extend(DS.HasManyEmbeddedRecordsMixin, {
    attrs: {
...
test("extractSingle with embedded objects inside embedded objects", function() {
  ...
  env.container.register('serializer:superVillain', DS.ActiveModelSerializer.extend(DS.HasManyEmbeddedRecordsMixin, {
    attrs: {
...
test("extractSingle with embedded objects of same type", function() {
  ...
  env.container.register('serializer:comment', DS.ActiveModelSerializer.extend(DS.HasManyEmbeddedRecordsMixin, {
    attrs: {
...
test("extractSingle with embedded objects of same type, but from separate attributes", function() {
  ...
  env.container.register('serializer:home_planet', DS.ActiveModelSerializer.extend(DS.HasManyEmbeddedRecordsMixin, {
    attrs: {
      villains: {embedded: 'always'},
